...
namespace ErosionBrushPlugin
{
	static public class Extensions
	{
		...
		public static CoordRect GetHeightRect (this Terrain terrain) 
		{
			...
			int posX = (int)(terrain.transform.position.x/pixelSize + 0.5f); if (terrain.transform.position.x < 0) posX--;
			int posZ = (int)(terrain.transform.position.z/pixelSize + 0.5f); if (terrain.transform.position.z < 0) posZ--;
